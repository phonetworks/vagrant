...
BuildRequires: php71w-devel >= 7.1
...
%pre
echo "This package requires PHP 5.6 from Webtatic repository" > /dev/stderr
echo "https://webtatic.com/packages/php56" > /dev/stderr
